...
target_real = Tensor(opt.batch_size, 1).fill_(1.0) # 必须根据每个batch的大小来定义target_real的大小 否则可能会在最后一个batch出错，即数量不满足batch_size
...
dataloader = DataLoader(ImageDataset(opt.trainA, opt.trainB, transforms_=transforms_, unaligned=True), 
