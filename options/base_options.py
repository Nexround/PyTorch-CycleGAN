...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--tensorboard_dir', required=False, default='runs/', type=str, help='tensorboard dir')
        ...
        parser.add_argument('--lambda_B2A', type=float, default=1.0, help='weight for B2A')
